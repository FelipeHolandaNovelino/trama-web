...
function TimelineModeTabs({ selectedMode, onSelectMode }) {
  return (
    <div className="grid w-full grid-cols-2 gap-1 rounded-2xl border border-slate-200 bg-slate-50/60 p-1 sm:flex lg:w-auto">
      {timelineModes.map((mode) => {
        ...
        return (
          <button
            ...
            className={`rounded-xl px-3 py-2 text-xs font-semibold transition sm:flex-1 lg:flex-none ${
              isActive
      ...
      <header className="flex flex-col gap-3 border-b border-slate-200 pb-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <p className="hidden text-sm text-slate-500 md:line-clamp-1 md:block">
